...
class BedtoolsIntersectArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/bedtools:2.31.1--hf5e1c6e_2.")
  var image: String = "quay.io/biocontainers/bedtools:2.31.1--hf5e1c6e_2"

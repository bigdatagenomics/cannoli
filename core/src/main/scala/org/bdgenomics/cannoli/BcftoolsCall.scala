...
class BcftoolsCallArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-docker_image", usage = "Container image to use. Defaults to quay.io/biocontainers/bcftools:1.14--hde04aa1_1.")
  var image: String = "quay.io/biocontainers/bcftools:1.14--hde04aa1_1"

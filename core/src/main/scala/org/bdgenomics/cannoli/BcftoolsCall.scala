...
class BcftoolsCallArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-docker_image", usage = "Container image to use. Defaults to quay.io/biocontainers/bcftools:1.13--h3a49de5_0.")
  var image: String = "quay.io/biocontainers/bcftools:1.13--h3a49de5_0"

...
class BlastnArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/blast:2.13.0--hf3cf87c_0.")
  var image: String = "quay.io/biocontainers/blast:2.13.0--hf3cf87c_0"

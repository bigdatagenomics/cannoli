...
class Minimap2Args extends ReadGroupArgs {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/minimap2:2.28--he4a0461_3.")
  var image: String = "quay.io/biocontainers/minimap2:2.28--he4a0461_3"

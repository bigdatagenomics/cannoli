...
class BwaMem2Args extends ReadGroupArgs {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/bwa-mem2:2.2.1--hd03093a_5.")
  var image: String = "quay.io/biocontainers/bwa-mem2:2.2.1--hd03093a_5"

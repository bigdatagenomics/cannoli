...
class VtNormalizeArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/vt:0.57721--hf1e2573_5.")
  var image: String = "quay.io/biocontainers/vt:0.57721--hf1e2573_5"

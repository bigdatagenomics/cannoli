...
class BowtieArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/bowtie:1.2.3--py37hc9558a2_0.")
  var image: String = "quay.io/biocontainers/bowtie:1.2.3--py37hc9558a2_0"

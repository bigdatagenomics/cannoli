...
/**
 * STAR function arguments.
 */
class StarArgs extends Args4jBase {
  @Args4jOption(required = false, name = "-executable", usage = "Path to the STAR executable. Defaults to STAR.")
  var executable: String = "STAR"

  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/star:2.7.1a--0.")
  var image: String = "quay.io/biocontainers/star:2.7.1a--0"
  ...
  @Args4jOption(required = false, name = "-use_docker", usage = "If true, uses Docker to launch STAR.")
  var useDocker: Boolean = false

  @Args4jOption(required = false, name = "-use_singularity", usage = "If true, uses Singularity to launch STAR.")
  var useSingularity: Boolean = false

  @Args4jOption(required = true, name = "-genome", usage = "Path to the directory where the STAR genome files are stored.")
  var genomePath: String = null

  @Args4jOption(required = false, name = "-star_args", usage = "Additional arguments for STAR, must be double-quoted, e.g. -star_args \"--outSAMmultNmax 4 --clip5pNbases 12\"")
...
/**
 * STAR wrapper as a function FragmentDataset &rarr; AlignmentRecordDataset,

...
class BwaMemArgs extends ReadGroupArgs {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/bwa:0.7.17--h5bf99c6_8.")
  var image: String = "quay.io/biocontainers/bwa:0.7.17--h5bf99c6_8"

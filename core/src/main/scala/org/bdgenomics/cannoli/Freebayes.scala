...
class FreebayesArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/freebayes:1.3.6--h346b5cb_1.")
  var image: String = "quay.io/biocontainers/freebayes:1.3.6--h346b5cb_1"

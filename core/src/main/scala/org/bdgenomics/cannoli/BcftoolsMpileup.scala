...
class BcftoolsMpileupArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-docker_image", usage = "Container image to use. Defaults to quay.io/biocontainers/bcftools:1.10.2--hd2cd319_0.")
  var image: String = "quay.io/biocontainers/bcftools:1.10.2--hd2cd319_0"

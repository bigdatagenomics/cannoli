...
class SamtoolsMpileupArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-docker_image", usage = "Container image to use. Defaults to quay.io/biocontainers/samtools:1.12--hd5e65b6_0.")
  var image: String = "quay.io/biocontainers/samtools:1.12--hd5e65b6_0"

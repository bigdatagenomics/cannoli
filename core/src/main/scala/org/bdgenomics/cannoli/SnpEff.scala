...
class SnpEffArgs extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/snpeff:5.1--hdfd78af_1.")
  var image: String = "quay.io/biocontainers/snpeff:5.1--hdfd78af_1"

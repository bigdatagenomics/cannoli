...
import org.bdgenomics.cannoli.{ Snap => SnapFn, SnapArgs => SnapFnArgs }
import org.bdgenomics.utils.cli._
import org.kohsuke.args4j.{ Argument, Option => Args4jOption }

object Snap extends BDGCommandCompanion {
  val commandName = "snap"
  val commandDescription = "Align paired-end reads in a fragment dataset with SNAP."
...
/**
 * Scalable Nucleotide Alignment Program (SNAP) command line wrapper.
 */

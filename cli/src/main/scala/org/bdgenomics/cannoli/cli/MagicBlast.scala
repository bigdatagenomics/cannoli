...
import org.bdgenomics.cannoli.{ MagicBlast => MagicBlastFn, MagicBlastArgs => MagicBlastFnArgs }
...
/**
 * MagicBlast command line wrapper.
 */
class MagicBlast(protected val args: MagicBlastArgs) extends BDGSparkCommand[MagicBlastArgs] with Logging {
  val companion = MagicBlast
